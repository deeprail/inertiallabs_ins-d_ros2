    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'inertiallabs_msgs.msg.SensorData')
            logger.debug(
...
class SensorData(metaclass=Metaclass_SensorData):
    ...
    def __init__(self, **kwargs):
        ...
        self.vinp = kwargs.get('vinp', float())
        self.pressure = kwargs.get('pressure', float())
        self.barometric_height = kwargs.get('barometric_height', float())
    ...
    def __eq__(self, other):
        ...
        if self.temp != other.temp:
            return False
        if self.vinp != other.vinp:
            return False
        if self.pressure != other.pressure:
            return False
        if self.barometric_height != other.barometric_height:
            return False
        return True
    ...
    def vinp(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'vinp' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'vinp' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._vinp = value
    ...
    @builtins.property
    def barometric_height(self):
        """Message field 'barometric_height'."""
        return self._barometric_height

    @barometric_height.setter
    def barometric_height(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'barometric_height' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'barometric_height' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._barometric_height = value
