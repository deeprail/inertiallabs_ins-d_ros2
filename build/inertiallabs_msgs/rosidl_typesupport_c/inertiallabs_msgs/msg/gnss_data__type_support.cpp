...
static const _GnssData_type_support_symbol_names_t _GnssData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, inertiallabs_msgs, msg, GnssData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, inertiallabs_msgs, msg, GnssData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, inertiallabs_msgs, msg, GnssData)() {
  return &::inertiallabs_msgs::msg::rosidl_typesupport_c::GnssData_message_type_support_handle;
}
