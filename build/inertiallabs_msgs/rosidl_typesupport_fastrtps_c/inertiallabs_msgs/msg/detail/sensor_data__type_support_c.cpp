...
#include "inertiallabs_msgs/msg/detail/sensor_data__rosidl_typesupport_fastrtps_c.h"
...
using _SensorData__ros_msg_type = inertiallabs_msgs__msg__SensorData;
...
size_t get_serialized_size_inertiallabs_msgs__msg__SensorData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SensorData__ros_msg_type * ros_message = static_cast<const _SensorData__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SensorData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_inertiallabs_msgs__msg__SensorData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_inertiallabs_msgs
size_t max_serialized_size_inertiallabs_msgs__msg__SensorData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = inertiallabs_msgs__msg__SensorData;
    is_plain =
      (
...
static size_t _SensorData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_inertiallabs_msgs__msg__SensorData(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, inertiallabs_msgs, msg, SensorData)() {
