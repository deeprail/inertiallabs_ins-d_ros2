...
#include "inertiallabs_msgs/msg/detail/gps_data__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // llh
...
using _GpsData__ros_msg_type = inertiallabs_msgs__msg__GpsData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: horspeed
  {
    cdr << ros_message->horspeed;
  }

  // Field name: speeddir
  {
    cdr << ros_message->speeddir;
  }

  // Field name: verspeed
  {
    cdr << ros_message->verspeed;
  }
...
size_t get_serialized_size_inertiallabs_msgs__msg__GpsData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GpsData__ros_msg_type * ros_message = static_cast<const _GpsData__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name horspeed
  {
    size_t item_size = sizeof(ros_message->horspeed);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name speeddir
  {
    size_t item_size = sizeof(ros_message->speeddir);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name verspeed
  {
    size_t item_size = sizeof(ros_message->verspeed);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _GpsData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_inertiallabs_msgs__msg__GpsData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_inertiallabs_msgs
size_t max_serialized_size_inertiallabs_msgs__msg__GpsData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = inertiallabs_msgs__msg__GpsData;
    is_plain =
      (
      offsetof(DataType, verspeed) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _GpsData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_inertiallabs_msgs__msg__GpsData(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, inertiallabs_msgs, msg, GpsData)() {
