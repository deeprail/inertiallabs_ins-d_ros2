...
#include "inertiallabs_msgs/msg/detail/gps_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const inertiallabs_msgs::msg::GpsData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  inertiallabs_msgs::msg::GpsData & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = inertiallabs_msgs::msg::GpsData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const inertiallabs_msgs::msg::GpsData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<inertiallabs_msgs::msg::GpsData *>(
    untyped_ros_message);
...
get_message_type_support_handle<inertiallabs_msgs::msg::GpsData>()
{
  return &inertiallabs_msgs::msg::typesupport_fastrtps_cpp::_GpsData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, inertiallabs_msgs, msg, GpsData)() {
  return &inertiallabs_msgs::msg::typesupport_fastrtps_cpp::_GpsData__handle;
}
